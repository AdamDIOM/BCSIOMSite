...
export default function Footer(){
    return(
            <Row className="footer">
                ...
                <Col sm={4} xs={12} className="chamber-logo-container d-flex flex-wrap align-items-center">
                    <a href="https://www.iomchamber.org.im/" target="_blank" rel="noreferrer">
                        <img className="chamber-logo" src="img/proud-chamber-member.png" alt="BCS IOM is a proud member of the Isle of Man Chamber of Commerce." />
                    </a>
                </Col>
                
                <Col md={4} s={12} className="footer-texts">
